...
```{r, echo = FALSE, fig.cap="The original PB figure (Richardson et al., 2023)"}
knitr::include_graphics("./cvd_simulations/pb.png")
```
```{r, echo = FALSE, fig.cap="Deuteranopia simulation"}
knitr::include_graphics("./cvd_simulations/pb-Deuteranopia.png")
```
```{r, echo = FALSE, fig.cap="Protanopia simulation"}
knitr::include_graphics("./cvd_simulations/pb-Protanopia.png")
```
```{r, echo = FALSE, fig.cap="Tritanopia simulation"}
knitr::include_graphics("./cvd_simulations/pb-Tritanopia.png")
```
```{r, echo = FALSE, fig.cap="Full colour blindness (gray scale)"}
knitr::include_graphics("./cvd_simulations/pb-Grey-scale.png")
```
